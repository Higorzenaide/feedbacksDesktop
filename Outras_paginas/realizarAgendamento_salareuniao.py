...
def main():
    ...
    st.write("O site da sala de reunião está sendo migrado, estamos passando todos os agendamentos para o outro site. Dentro de 01hr liberamos o novo link, mais ainda é possível visualizar os agendamentos. Atenciosamente COP")
    return
